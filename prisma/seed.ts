...
async function main() {
  ...
  const staffData = [
    ...
    },
    {
      ...
      passwordHash: hashValue("@dn1m@26"),
      pinHash: hashValue("2026"),
      assignedCodes: ["LBC", "LBD"],
    },
    {
      employeeId: "prashant.patil",
      name: "Prashant Patil",
      email: "prashant.patil@suas.ac.in",
      mobile: "9999999915",
      designation: "Lab Assistant",
      passwordHash: hashValue("@dn1m@26"),
      pinHash: hashValue("2026"),
      assignedCodes: ["LBE", "LBF"],
    },
    {
      employeeId: "salman.khan",
      name: "Salman Khan",
      email: "salman.khan@suas.ac.in",
      mobile: "9999999917",
      designation: "Practice Trainer",
      passwordHash: hashValue("@dn1m@26"),
      pinHash: hashValue("2026"),
      assignedCodes: ["LBG", "LBH", "LBI"],
    },
  ];
